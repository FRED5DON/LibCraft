...
import ts.app.sagosoft.com.libcraft.widget.scroller.UIScrollLabel;

/**
 * Created by fred on 16/8/29.
 */
public class ScrollersActivity extends BaseActivity {


    @InjectView(R.id.tv_uilabel)
    UIScrollLabel tvUilabel;

    public static Intent mkIntent(Context context) {
        Intent intent = new Intent(context, ScrollersActivity.class);
        return intent;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.scroll_uilabel);
