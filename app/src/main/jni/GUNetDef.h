...
//  MyGoUDome
//
//  Created by uistrong on 13-3-28.
...
// 数据相关错误码
#define NET_DATA_ERROR -1000 // 服务器返回数据错误,非预期数据

// 用户错误码
#define NET_USER_TIMEOUT -2000 // 用户操作操作超时
#define NET_USER_NOTLOGIN -2001 // 尚未登陆 
#define NET_NETWORK_INVALID -2002 // 无网络连接
